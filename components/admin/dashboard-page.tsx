      ...
      >
        ...
        <View style={{ padding: 14, gap: 12 }}>
          ...
          <View style={{ flexDirection: "row", gap: 10 }}>
            <StatCard icon="👥" value={`${totalEmployees} 人`} label="在職員工" iconBg="#EFF6FF" onPress={() => navigate("employees")} />
            <StatCard icon="✅" value={`${presentCount} 人`} label="今日已打卡" iconBg="#F0FDF4" onPress={() => navigate("attendance")} />
          </View>
