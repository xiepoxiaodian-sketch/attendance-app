...
- [ ] 後端新增每日定時清除 7 天前打卡照片的 cron job（S3 刪除 + DB 欄位清空）

## 返回鍵與登出修復

- [ ] 所有頁面加返回鍵（員工端：打卡記錄、請假、個人資料等子頁面）
- [ ] 管理後台所有頁面加返回鍵
- [ ] 列印預覽畫面加返回鍵
- [ ] 修復員工帳號登出按鈕無反應問題
- [ ] 打卡記錄加狀態篩選（遲到、早退、未打卡、正常等）
- [ ] 打卡記錄改為同一員工同一天上班/下班並列顯示（一行一天）
- [ ] 報表匯出改為 Excel 格式（.xlsx）

## 排班人力統計修復

- [ ] 修復排班頁面內場/外場/幹部人力統計顯示 0 的問題（員工分類欄位未正確對應）
